...
export const Banner = () => {
  ...
  const toRotate = ["Software Developers", "Hardware Developers"];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  <span className="tagline">Welcome to our Team</span>
                  <h1>
                    {`Hi! We are Atom. `}{" "}
                    <span
                      className="txt-rotate"
                      dataPeriod="1000"
                      data-rotate='[ "Software Developers", "Hardware Developers" ]'
                    >
